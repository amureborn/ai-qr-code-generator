...
! function(e) {
    ...
    noColorSelectedText: "Î”ÎµÎ½ Î­Ï‡ÎµÎ¹ ÎµÏ€Î¹Î»ÎµÏ‡Î¸ÎµÎ¯ ÎºÎ¬Ï€Î¿Î¹Î¿ Ï‡ÏÏŽÎ¼Î±",
        ...
        qrcdr: function(t) {
            ...
            return this.each(function() {
                ...
                e("[maxlength]").maxlength({
                    ...
                    e(this).prop("checked") ? e(t).collapse("show") : e(t).collapse("hide")
                }), u.on("change", function() {
                    var t = e(this).data("target");
                    e(this).prop("checked") ? e(t).collapse("hide") : e(t).collapse("show")
                }), u.each(function() {
                    var t = e(this).data("target");
                    e(this).prop("checked") ? e(t).collapse("hide") : e(t).collapse("show")
                }), p.on("change", function() {
                    e(this).prop("checked") ? (r.spectrum("set", "transparent"), r.spectrum("disable")) : (r.spectrum("set", "#ffffff"), r.spectrum("enable"))
                }), p.prop("checked") ? (r.spectrum("set", "transparent"), r.spectrum("disable")) : (r.spectrum("set", "#ffffff"), r.spectrum("enable"));
                var ee = document.getElementsByClassName("needs-validation");
                Array.prototype.filter.call(ee, function(e) {
                ...
                function te() {
                    e(".toast").toast("hide"), clearTimeout(x), h.attr("disabled", !0), s.html(""), g.data("nopdf", !1), x = setTimeout(function() {
                        a[0].checkValidity() || c.click(), r.spectrum("enable"), l.fadeIn(100, function() {
                            var t = Y.find(V + " :input"),
                                a = "section=" + V + "&";
                            a += t.filter(function(t, a) {
                                return "" != e(a).val()
                            }).serialize(), a += "&", a += q.filter(function(t, a) {
                                return "" != e(a).val()
                            }).serialize(), e.ajax({
                                type: "POST",
                                url: S + "ajax/process.php",
                                cache: !1,
                                data: a
                            }).fail(function(t) {
                                d.html(t.statusText), e(".toast").toast("show")
                            }).done(function(t) {
                                p.prop("checked") && r.spectrum("disable");
                                var a = JSON.parse(t);
                                a.hasOwnProperty("errore") ? (d.html(a.errore), e(".toast").toast("show"), g.html('<img src="' + a.placeholder + '">'), l.fadeOut("slow")) : (v.val(t), h.attr("disabled", !1), g.html(a.content), g.data("nopdf", a.nopdf), l.fadeOut("slow"))
                            })
                        })
                    }, 1e3)
                }
                ...
                function ae(t) {
                    var a = t.target;
                    e(a).hasClass("nopreview") || (h.attr("disabled", !0), s.html(""), clearTimeout(x), x = setTimeout(function() {
                        te()
                    }, 1e3))
                }
                ...
                function ne() {
                    var t = v.val();
                    l.fadeIn(100, function() {
                        e.ajax({
                            type: "POST",
                            url: S + "ajax/create.php",
                            cache: !1,
                            data: {
                                create: t
                            }
                            ...
                            if (t.length) {
                                var a = JSON.parse(t);
                                if (a.error) bootbox.alert({
                                    message: a.error,
                                    size: "small"
                                });
                                else {
                                    var n = a.filedir + "/" + a.basename,
                                        o = '<button class="btn btn-default svgtopng" data-path="' + n + '">' + J + '</button><a href="#" class="btn btn-default d-none preload-png">' + X + '</a><a class="serve-png d-none" href="' + n + '.png" download="' + a.basename + '.png" data-path="' + n + '">PNG</a>';
                                    o = o + '<a class="btn btn-default serve-svg" href="' + n + '.svg" download="' + a.basename + '.svg">' + W + "</a>", g.data("nopdf") || (o = o + '<a target="_blank" class="btn btn-default" href="' + S + "pdf/?f=" + a.basename + '">' + Q + "</a>"), o = o + '<button class="btn btn-default print">' + K + "</button>", s.html(o), h.attr("disabled", !0), Y.find(".print").on("click", function() {
                                        var t, a;
                                        t = e(".serve-svg").attr("href"), (a = window.open("about:blank", "_new")).document.open(), a.document.write('<html><head></head><body onload="window.print()" onafterprint="window.close()"><img src="' + t + '"/></body></html>'), a.document.close()
                                    })
                                }
                            }
                            l.fadeOut("slow")
                ...
                function oe() {
                    if (e("#map-canvas").length) {
                        M = e("#map-canvas").data("lat"), L = e("#map-canvas").data("lng");
                        var t, a, n = new google.maps.LatLng(M, L),
                            o = document.getElementById("pac-input"),
                            c = document.getElementById("latlong"),
                            s = document.getElementById("latbox"),
                            i = document.getElementById("lngbox"),
                            r = {
                                zoom: 10,
                                center: n
                            };
                        C = new google.maps.Map(document.getElementById("map-canvas"), r), a = new google.maps.places.SearchBox(o), t = new google.maps.Marker({
                            map: C,
                            draggable: !0,
                            animation: google.maps.Animation.DROP,
                            position: n
                        }), google.maps.event.addListener(t, "dragend", function(e) {
                            var a = t.getPosition().lat() + "," + t.getPosition().lng();
                            l(a)
                        }), C.controls[google.maps.ControlPosition.TOP_LEFT].push(c), s.value.length > 0 && i.value.length > 0 && d(Number(s.value), Number(i.value)), google.maps.event.addListener(a, "places_changed", function() {
                            var e = a.getPlaces();
                            if (0 != e.length)
                                for (var n, o = 0; n = e[o]; o++) t.setPosition(n.geometry.location), C.setCenter(n.geometry.location), l()
                        })
                    }
                    var l = function() {
                            s.value = t.getPosition().lat(), i.value = t.getPosition().lng(), te()
                        },
                        d = function(e, a) {
                            C.setCenter({
                                lat: e,
                    ...
                    e("#latbox, #lngbox").on("input", function() {
                        s.value.length > 0 && i.value.length > 0 && d(Number(s.value), Number(i.value))
                    })
                }
                n.on("input", ae), o.on("change", function(t) {
                        var a = t.target;
                        e(a).hasClass("nopreview") || te()
                    }), h.on("click", function() {
                        ne()
                    }), e(document).on("click", ".svgtopng", function() {
                        var t, a, n, o, c, s, i, r;
                        i = Y.find(".svgtopng"), r = i.parent().find(".serve-png"), c = i.parent().find(".preload-png"), i.addClass("d-none"), c.removeClass("d-none"), o = r.attr("download"), s = i.data("path") + ".svg", t = new Image, l.fadeIn(100, function() {
                            t.onload = function() {
                                a = document.createElement("canvas"), n = a.getContext("2d"), setTimeout(function() {
                                    var s = 2 * t.width,
                                        d = 2 * t.height;
                                    a.width = s, a.height = d, n.drawImage(t, 0, 0, s, d);
                                    var p = a.toDataURL();
                                    e.ajax({
                                        type: "POST",
                                        url: S + "ajax/png.php",
                                        ...
                                        "error" == e ? bootbox.alert({
                                            message: "File not found",
                                            size: "small"
                                        }) : (c.addClass("d-none"), i.removeClass("d-none"), r[0].click()), l.fadeOut("slow")
                                    })
                                }, 100)
                            }, t.src = s
                        })
                    }), f.on("change", function(a) {
                        if (e(this).removeClass("is-invalid"), this.files[0].type.match("image.*")) {
                            var n = this.files[0],
                                o = new Image;
                            o.crossOrigin = "Anonymous";
                            var c = new FileReader;
                            n.type.indexOf("svg") > 0 && (w = "svg"), c.onload = function(t) {
                                e(".logoselecta label").removeClass("active").find("input").removeAttr("checked");
                                var a = '<img src="' + t.target.result + '" class="user_watermark">';
                                e(".custom-watermark .hold-custom-watermark").html(a), o.src = e(".logoselecta .btn-group-toggle label").last().find("img").attr("src"), e(".custom-watermark").addClass("active"), e(".custom-watermark input").val(t.target.result).prop("checked", !0)
                            }, c.readAsDataURL(n), o.onload = function() {
                                var a = document.createElement("canvas"),
                                    n = this.width,
                                    c = this.height;
                                if (!t.svglogo || t.svglogo && "svg" !== w) {
                                    if (0 == n || 0 == c) return e("#upmarker").addClass("is-invalid"), e(".logoselecta .btn-group-toggle label").last().remove(), !1;
                                    a.getContext("2d").drawImage(o, 0, 0), n > c ? (c *= 400 / n, n = 400) : (n *= 400 / c, c = 400), a.width = n, a.height = c, a.getContext("2d").drawImage(o, 0, 0, n, c);
                                    var s = a.toDataURL();
                                    e(".logoselecta .btn-group-toggle label").last().find("img").attr("src", s), e(".logoselecta .btn-group-toggle label").last().find("input[name='optionlogo']").val(s)
                                }
                            }
                        } else e(this).addClass("is-invalid")
                    }), t.svglogo || e(".logoselecta img").each(function() {
                        var t = e(this);
                        if ("svg" == t.attr("src").split(".").pop()) {
                            var a = new Image;
                            a.crossOrigin = "Anonymous", a.onload = function() {
                                var e = this.width,
                                    n = this.height;
                                if (!e || !n) return t.parent().remove(), !1;
                                var o = document.createElement("canvas"),
                                    c = o.getContext("2d");
                                e > n ? (n *= 400 / e, e = 400) : (e *= 400 / n, n = 400), o.width = e, o.height = n, c.drawImage(a, 0, 0, e, n);
                                var s = o.toDataURL();
                                t.parent().find("input").attr("value", s)
                            }, a.src = t.attr("src")
                        }
                    }), b.length && (e(".datetimepicker-input").datetimepicker({
                        format: "LLL"
                    }), e(".datetimepicker-input").on("change.datetimepicker", function(t) {
                        var a = e(this).data("timestamp");
                        e(a).attr("value", t.date.unix())
                    })),
                    function(t, a) {
                        if (e("#wpol-admin-map").length) {
                            if (M = e("#wpol-admin-map").data("lat"), L = e("#wpol-admin-map").data("lng"), "undefined" == typeof ol || null === ol) return console.log("WARNING: OpenLayers Library not loaded"), !1;
                            var n = ol.proj.fromLonLat([L, M]),
                                o = new ol.View({
                                    center: n,
                                    zoom: 4
                                });
                            ...
                            C.addOverlay(i), C.getInteractions().forEach(function(e) {
                                e instanceof ol.interaction.DragPan && (c = e)
                            }), s.addEventListener("mousedown", function(e) {
                                c.setActive(!1), i.set("dragging", !0)
                            }), C.on("pointermove", function(e) {
                                !0 === i.get("dragging") && i.setPosition(e.coordinate)
                            }), C.on("pointerup", function(t) {
                                if (!0 === i.get("dragging")) {
                                    c.setActive(!0), i.set("dragging", !1);
                                    var a = t.coordinate,
                                        n = ol.proj.toLonLat(a);
                                    e(".venomaps-get-lat").val(n[1]), e(".venomaps-get-lon").val(n[0]), te()
                                }
                            }), e(".venomaps-get-coordinates").on("click", function() {
                                var t = e(this),
                                    a = e(".venomaps-set-address").val();
                                if (a.length > 3) {
                                    t.hide();
                                    ...
                                    e.ajax({
                                        ...
                                        var a, n, c, s;
                                        n = (a = t)[0].lat, c = a[0].lon, s = ol.proj.fromLonLat([c, n]), i.setPosition(s), o.setCenter(s), o.setZoom(6), e(".venomaps-get-lat").val(n), e(".venomaps-get-lon").val(c), te()
                                    }).always(function() {
                                        t.fadeIn()
                                    })
                                }
                            }), e(".setinput-latlon").on("input", function() {
                                ! function(e, t) {
                                    var a = ol.proj.fromLonLat([t, e]);
                                    i.setPosition(a), o.setCenter(a)
                                }(e(".venomaps-get-lat").val(), e(".venomaps-get-lon").val())
                            })
                        }
                    }(0, "infomarker_admin"), oe(), O.on("shown.bs.tab", function(t) {
                        V = e(t.target).attr("href"), e("#getsec").val(V).change();
                        var a = location.href.split("#")[0] + V;
                        history.replaceState(null, null, a), "#location" == V && (oe(), e("#wpol-admin-map").length && C.updateSize())
                    }), y.on("change", function() {
                        var t = e(this).val(),
                            a = e(this).data("target");
                        e(a).html(t)
                    }), e("#pp_type").on("change", function() {
                        "_donations" === e(this).val() ? (z.addClass("d-none"), k.removeClass("col-sm-3")) : (z.removeClass("d-none"), k.addClass("col-sm-3"))
                    }), I.on("input", function() {
                        var t = I.val();
                        e.ajax({
                            method: "POST",
                            url: S + "ajax/btc-check.php",
                            data: {
                                btc_account: t
                            }
                        }).done(function(e) {
                            e ? I.removeClass("is-invalid").addClass("is-valid") : I.removeClass("is-valid").addClass("is-invalid")
                        })
                    }), D.cropit({
                        type: "image/jpeg",
                        quality: .9,
                        ...
                        onImageLoaded: function() {
                            E.removeClass("d-none"), H.removeClass("d-none"), e(".cropit-preview-image").css("opacity", 1), e(".cropit-preview-background").css("opacity", .2), U.addClass("cropit-image-loaded")
                        }
                    }), A.on("click", function() {
                        N.click()
                    }), H.on("click", function() {
                        var e = D.cropit("export");
                        _.attr("value", e).change(), Z.removeClass("d-none")
                    }), E.on("click", function() {
                        e(".cropit-preview-image").css("opacity", 0), e(".cropit-preview-background").css("opacity", 0), E.addClass("d-none"), H.addClass("d-none"), Z.addClass("d-none"), F.removeClass("cropit-image-loaded"), U.removeClass("cropit-image-loaded"), _.attr("value", "").change()
                    }), R.on("show.bs.collapse", function() {
                        T.prop("checked", !1).change(), T.parent(".custom-switch").hide(), j.prop("checked", !1).change(), j.parent(".custom-switch").hide()
                    }), R.on("hidden.bs.collapse", function() {
                        T.parent(".custom-switch").fadeIn(), j.parent(".custom-switch").fadeIn()
                    })
            })
        }
    })
